...
<div class="page-container">
        <form method="post" id="myFormId" action="/index.php/Admin/User/showList">
			<div class="text-c">
				会员昵称：<input type="text" name="user_name" placeholder="请输入会员昵称" style="width:150px" class="input-text">
