...
<body>
    <article class="page-container">
        <form class="form form-horizontal" id="form-article-add" method="post" action="/index.php/Admin/Shop/addCategory" enctype="multipart/form-data" onsubmit="return false">
            <div class="row cl">
    ...
    $(function() {
        ...
        $("#form-article-add").validate({
            ...
            submitHandler: function(form) {
                $(form).ajaxSubmit({
                    type: 'post',
                    url: "/index.php/Admin/Shop/addCategory/id/<?php echo $id ?>",
                    data: $("form").serialize(),
                    dataType: "json",
                    success: function(data) {
                        if (data.code == 1) {
                            layer.msg(data.msg, {
                                ...
                                if (data.id == 1) {
                                    window.location.href = "/index.php/Admin/Shop/showList";
                                } else {
