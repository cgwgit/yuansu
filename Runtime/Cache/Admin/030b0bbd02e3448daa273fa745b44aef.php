...
<article class="page-container">
	<form class="form form-horizontal" id="form-article-add" method="post" action="/index.php/Admin/Goods/addAction" enctype="multipart/form-data" onsubmit="return false">
		<div class="row cl">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">活动主题照片：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="file" class="input-text" value="20" placeholder="" id="articlesort" name="pic">(图片大小：750*440)
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>随机数位数：</label>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select name="articletype" class="select">
					...
					<option value="1.00">1.00元</option>
					<option value="10.00">10.00元</option>
				</select>
				</span> </div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">最大参与人数：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="20" placeholder="" id="articlesort" name="articlesort">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9 skin-minimal">
				 <input type="text" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',maxDate:'#F<?php echo ('2020-10-01'($dp["$D('datemax')"])); ?>',minDate:'#F{'%y-%M-%d'}',autoPickDate:true})" id="datemin" name="startTime" class="input-text Wdate valid" style="width:200px;">
				 <input type="text" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',minDate:'#F<?php echo ('%y-%M-%d'($dp["$D('datemin')"])); ?>',autoPickDate:true})" class="input-text Wdate valid" style="width:200px;" id="datemax" name="endTime">
			</div>
		</div>
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				...
				<a href="/index.php/Admin/Goods/showList" ><button class="btn btn-default radius" type="button">&nbsp;&nbsp;取消&nbsp;&nbsp;</button></a> -->
			</div>
		</div>
	</form>
</article>
...
$(function(){
	...
	$("#form-article-add").validate({
		...
		submitHandler:function(form){
			$(form).ajaxSubmit({
				type: 'post',
				url: "/index.php/Admin/Goods/addAction/id/<?php echo $id ?>",
				data:$("form").serialize(),
				dataType: "json",
