...
<!--            <div class="text-c">
           ...
           <!--   -->
            <div class="mt-20">
                <table class="table table-border table-bordered table-bg table-hover table-sort">
                    ...
                    <tbody>
                    <?php if(is_array($banner)): foreach($banner as $key=>$v): ?><tr class="text-c">
                            ...
                            <td class="td-manage">
                                <a title="编辑" href="/index.php/Admin/Banner/editBanner/id/<?php echo $v['id'] ?>" class="ml-10" style="text-decoration:none">
                                    <i class="Hui-iconfont">&#xe6df;</i>
                                </a>
                             <!--    <a title="删除" href="javascript:;" onclick="activity_del(this,'<?php echo $v['id'] ?>')" class="ml-10" style="text-decoration:none">
                                    <i class="Hui-iconfont">&#xe6e2;</i>
                                </a> -->
                               <a href="javascript:;" class="ml-10" onclick="activity_detail('查看','/index.php/Admin/Banner/showList/id/<?php echo $v['id'] ?>','800','500')">查看</a>
                            </td>
        ...
        <script type="text/javascript">
            ...
            function activity_stop(obj, id) {
                layer.confirm('确认要关闭吗？', function(index) {
                               $.ajax({
                                type: "get",
                                dataType: "json",
                                url: '/index.php/Admin/Banner/endAction',
                                data: {'aid':id},
                ...
                layer.confirm('确认要开启吗？', function(index) {
                    //此处请求后台程序，下方是成功后的前台处理……
                           $.ajax({
                                type: "get",
                                dataType: "json",
                                url: '/index.php/Admin/Banner/startAction',
                                data: {'aid':id},
                                success: function (data) {
                                    if(data.code == 0) {
            ...
            function activity_del(obj, id) {
                layer.confirm('确认要删除吗？', function(index) {
                    $.ajax({
                        type: 'get',
                        url: '/index.php/Admin/Banner/delCategory',
                        data:{'aid':id},
                        dataType: 'json',
                        success: function(data) {
                            if(data.code == 1){
    ...
    //给删除按钮添加点击事件(批量删除)
        ...
        window.location.href = '/index.php/Admin/Banner/delAction/aid/' + ids; //Tp框架中的写法
    };
$(function(){
    //给编辑按钮添加点击事件
    $('#btnedit').on('click',function(){
        ...
        //跳转
        window.location.href = '/index.php/Admin/Banner/edit/id/' + id;
    });
});
        </script>
    </body>
