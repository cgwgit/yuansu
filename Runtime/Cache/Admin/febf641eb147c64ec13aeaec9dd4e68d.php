    ...
    <body>
        ...
        <div style=" margin:auto;width:700px;height:300px;border:2px solid gray; margin-bottom:50px;" id="container"></div>
            <article class="page-container pl-20 pr-20">
                <form class="form form-horizontal" id="form-article-add" method="post" action="/index.php/Admin/Shop/addShop" enctype="multipart/form-data" onsubmit="return false">
                    <div class="row cl">
                    ...
                    <div class="row cl">
                        ...
                        <div class="formControls col-xs-8 col-sm-9">
                            <input type="text" class="input-text" value="" placeholder=""  name="shop_Tel">
                        </div>
                    </div>
                    <div class="row cl">
                    ...
                    <div class="row cl">
                        ...
                        <div class="formControls col-xs-8 col-sm-9">
                            <input type="text" class="input-text" value="" placeholder="" name="shop_Tuijian">
                        </div>
                    </div>
                    <div class="row cl">
                        <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>门店特色：</label>
                        <div class="formControls col-xs-8 col-sm-9">
                            <textarea name="shop_Tese" cols="" rows="" class="textarea" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！"></textarea>
