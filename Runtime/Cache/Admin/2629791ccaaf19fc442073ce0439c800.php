...
<![endif]-->
	...
	<body>
		<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 活动管理 <span class="c-gray en">&gt;</span> 活动列表
			<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新">
				<i class="Hui-iconfont">&#xe68f;</i></a>
		</nav>
		<div class="page-container">
<!-- 			<div class="text-c">
				<input type="text" name="" id="" placeholder="活动标题" style="width:250px" class="input-text">
			...
			<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" id="btndel" class="btn btn-danger radius" onclick="activity_dels(this)">
				...
				<a class="btn btn-primary radius" onclick="article_add('添加活动','/index.php/Admin/Index/addAction/','800','500')" href="javascript:;">
					<i class="Hui-iconfont">&#xe600;</i> 添加活动</a></span> <span class="r">共有数据：<strong><?php echo $allmoney[0][count] ?></strong> 条</span>
			</div>
			<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l">
				<i class="Hui-iconfont" id="btndel"></i> 活动总收入：￥<?php echo $allmoney[0][allmoney] ?></span>
			</div>
			<div class="mt-20">
				<table class="table table-border table-bordered table-bg table-hover table-sort">
					...
					<?php if(is_array($action)): foreach($action as $key=>$v): ?><tr class="text-c">
							...
							<td class="text-l"><u style="cursor:pointer" class="text-primary" onClick="article_list('查看','/index.php/Admin/Index/showList/aid/<?php echo $v['id'] ?>','800','500')" title="查看"><?php echo $v['title'] ?></u></td>
							...
							<?php else: ?>
                              <a style="text-decoration:none" onClick="activity_stop(this,'<?php echo $v['id'] ?>')" href="javascript:;" title="关闭">
								...
								<a title="编辑" href="/index.php/Admin/Index/editAction/aid/<?php echo $v['id'] ?>" class="ml-10" style="text-decoration:none">
									<i class="Hui-iconfont">&#xe6df;</i>
								</a>
		...
		<script type="text/javascript">
			...
			function activity_stop(obj, id) {
				layer.confirm('确认要关闭吗？', function(index) {
					           $.ajax({
						        type: "get",
						        dataType: "json",
						        url: '/index.php/Admin/Index/endAction',
						        data: {'aid':id},
				...
				layer.confirm('确认要开启吗？', function(index) {
					//此处请求后台程序，下方是成功后的前台处理……
                           $.ajax({
						        type: "get",
						        dataType: "json",
						        url: '/index.php/Admin/Index/startAction',
						        data: {'aid':id},
						        success: function (data) {
						            if(data.code == 0) {
			...
			function activity_del(obj, id) {
				layer.confirm('确认要删除吗？', function(index) {
					$.ajax({
						type: 'get',
						url: '/index.php/Admin/Index/delAction',
						data:{'aid':id},
						dataType: 'json',
						success: function(data) {
							if(data.code == 1){
    ...
    //给删除按钮添加点击事件(批量删除)
        ...
        window.location.href = '/index.php/Admin/Index/delAction/aid/' + ids; //Tp框架中的写法
    };
$(function(){
    //给编辑按钮添加点击事件
    $('#btnedit').on('click',function(){
        ...
        //跳转
        window.location.href = '/index.php/Admin/Index/edit/id/' + id;
    });
});
		</script>
	</body>
