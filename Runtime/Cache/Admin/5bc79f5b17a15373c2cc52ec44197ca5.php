...
<article class="page-container">
	<form class="form form-horizontal" id="form-article-add" method="post" action="/index.php/Admin/Banner/addAction" enctype="multipart/form-data" onsubmit="return false">
		<div class="row cl">
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				...
				<a href="/index.php/Admin/Banner/showList" ><button class="btn btn-default radius" type="button">&nbsp;&nbsp;取消&nbsp;&nbsp;</button></a> -->
			</div>
		</div>
	</form>
</article>
...
$(function(){
	...
	$("#form-article-add").validate({
		...
		submitHandler:function(form){
			$(form).ajaxSubmit({
				type: 'post',
				url: "/index.php/Admin/Banner/addAction/id/<?php echo $id ?>",
				data:$("form").serialize(),
				dataType: "json",
				success: function(data){
					if(data.code == 1){
						layer.msg(data.msg,{icon:1,time:1000},function(){
							if(data.id == 1){
								window.location.href="/index.php/Admin/Banner/showList";
							}else{
