...
<body>
    <article class="page-container">
        <form class="form form-horizontal" id="form-article-add" method="post" action="/index.php/Admin/XinPin/addXinPin" enctype="multipart/form-data" onsubmit="return false">
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2">新品名称：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text"  name="xinpin_Name">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2">链接地址：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text"  name="xinpin_url">
                </div>
            </div>
            <div class="row cl">
    ...
    $(function() {
        ...
        $("#form-article-add").validate({
            ...
            submitHandler: function(form) {
                $(form).ajaxSubmit({
                    type: 'post',
                    url: "/index.php/Admin/XinPin/addXinPin/",
                    data: $("form").serialize(),
                    dataType: "json",
