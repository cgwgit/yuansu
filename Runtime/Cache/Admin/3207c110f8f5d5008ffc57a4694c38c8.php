						...
						<ul class="cl">
							...
							<li class="dropDown dropDown_hover">
								...
								<ul class="dropDown-menu menu radius box-shadow">
									<li>
										<a href="/index.php/Admin/Manager/loginout">切换账户</a>
									</li>
									<li>
										<a href="/index.php/Admin/Manager/loginout">退出</a>
									</li>
								</ul>
							</li>
						</ul>
			...
			<div class="menu_dropdown bk_2">
				<dl id="menu-admin">
					...
					<dd>
						<ul>
							<li>
								<a data-href="/index.php/Admin/User/showList" data-title="会员列表" href="javascript:void(0);">会员列表</a>
							</li>
						</ul>
					</dd>
				</dl>
				...
				<dl id="menu-article">
					...
					<dd>
						<ul>
							<li>
								<a data-href="/index.php/Admin/Shop/shopList" data-title="门店列表" href="javascript:void(0);">门店列表</a>
							</li>
							<li>
								<a data-href="/index.php/Admin/Shop/addShop/id/1" data-title="添加门店" href="javascript:void(0);">添加门店</a>
							</li>
						</ul>
					</dd>
				</dl>
				<dl id="menu-article">
						<dt><i class="Hui-iconfont">&#xe681;</i> 购物专区<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
						<dd>
							<ul>
								<li>
									<a data-href="/index.php/Admin/GoodsBuy/showList" data-title="产品列表" href="javascript:void(0);">产品列表</a>
								</li>
								<li>
									<a data-href="/index.php/Admin/GoodsBuy/addGoods" data-title="添加产品" href="javascript:void(0);">添加产品</a>
								</li>
								<li>
									<a data-href="/index.php/Admin/Order/orderList" data-title="订单列表" href="javascript:void(0);">订单列表</a>
								</li>
							</ul>
						</dd>
					</dl>
				<dl id="menu-article">
					...
					<dd>
						<ul>
							...
							<li>
								<a data-href="/index.php/Admin/Category/addCategory/id/1" data-title="添加产品分类" href="javascript:void(0);">添加产品分类</a>
							</li>
						</ul>
					</dd>
				</dl>
					...
					<dd>
						<ul>
							<li>
								<a data-href="/index.php/Admin/Banner/showList" data-title="banner列表" href="javascript:void(0);">banner列表</a>
							</li>
							<li>
								<a data-href="/index.php/Admin/Banner/addBanner/id/1" data-title="添加banner" href="javascript:void(0);">添加banner</a>
							</li>
						</ul>
					</dd>
				</dl>
