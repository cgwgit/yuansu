	...
	<body>
		...
		<div class="ml-20 mr-20">
			...
			<div class="page-container">
				...
				<div class="row cl order-border-b pt-5 pb-5">
					<label class="form-label col-xs-4 col-sm-2 text-r">请填写物流信息：</label>
				</div>
				<div class="row cl order-border-b pt-5 pb-5">
					<label class="form-label col-xs-4 col-sm-2 text-r">快递方式：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" name="fahuo_danwei"  class="input-text" style="width:90%">
						<input type="hidden" name="order_id" value="<?php echo ($order_Info['order_id']); ?>" class="input-text" style="width:90%">
					</div>
				</div>
				<div class="row cl order-border-b pt-5 pb-5">
					<label class="form-label col-xs-4 col-sm-2 text-r">物流单号：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" name="fahuo_danhao"  class="input-text" style="width:90%">
					</div>
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2 text-r"></label>
				<div class="formControls col-xs-8 col-sm-9">
					<button  onClick="activity_start(this,'<?php echo $order_Info['order_id'] ?>')" class="btn btn-primary radius" ><i class="Hui-iconfont">&#xe632;</i> 提交</button>
			</div>
		</div>
        </form>
		<!--_footer 作为公共模版分离出去-->
