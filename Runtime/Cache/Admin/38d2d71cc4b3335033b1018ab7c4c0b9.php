...
<body>
    <article class="page-container">
        <form class="form form-horizontal" id="form-article-add" method="post" action="/index.php/Admin/Banner/editBanner" enctype="multipart/form-data" onsubmit="return false">
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2">banner名称：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text"  value="<?php echo ($banner['banner_name']); ?>" name="banner_Name">
                </div>
            </div>
            <div class="row cl">
    ...
    $(function() {
        ...
        $("#form-article-add").validate({
            ...
            submitHandler: function(form) {
                $(form).ajaxSubmit({
                    type: 'post',
                    url: "/index.php/Admin/Banner/editBanner/",
                    data: $("form").serialize(),
                    dataType: "json",
